...
class JsonDataset(object):
    ...
    def __init__(self, name):
        ...
        self.COCO = COCO(name) #(dataset_catalog.get_ann_fn(name))
    ...
    def _add_gt_annotations(self, entry):
        ...
        for obj in objs:
            ...
            if Segms.is_poly(obj['segmentation']):
            ...
            x1, y1, x2, y2 = bbox.xywh_to_xyxy(obj['bbox'])
            x1, y1, x2, y2 = bbox.clip_xyxy_to_image(
